...
const about = () => {
  return (
    <div className="flex flex-row h-[850px] w-full bg-slate-100 justify-center text-center  ">
      <div className=" mt-9 ">
        <img src="/Group4.png" alt="" className="w-[540px]" />
      </div>
        ...
        <div className="text-start ml-7">
          ...
          <div className="flex flex-row  mt-5">
            <div className="w-[200px] h-[170px] bg-[#595959]">
              <div className="flex flex-row text-center">
                <div className="flex flex-col mt-5 ml-5">
                  <img src="/Group6.png" alt="" className="w-9 mb-4" />
                  <img src="/Group5.png" alt="" className="w-4 h-16 ml-2" />
                </div>
                <div className="flex flex-col w-[70%] text-start ml-5 " >
                  <h5 className="my-5 text-white font-semibold">
                    Construction
                  </h5>
            ...
            <div className="w-[200px] h-[170px] bg-[#595959] ml-8">
              <div className="flex flex-row text-center">
                <div className="flex flex-col mt-5 ml-5">
                  <img src="/Group9.png" alt="" className="w-9 mb-4" />
                  <img src="/Group5.png" alt="" className="w-4 h-16 ml-2" />
                </div>
                <div className="flex flex-col w-[70%] text-start ml-5">
                  <h5 className="my-5 text-white font-semibold">
          ...
          <div className="flex flex-row  mt-5">
            <div className="w-[200px] h-[170px] bg-[#595959]">
              <div className="flex flex-row text-center">
                <div className="flex flex-col mt-5 ml-5">
                  <img src="/Group8.png" alt="" className="w-9 mb-4" />
                  <img src="/Group5.png" alt="" className="w-4 h-16 ml-2" />
                </div>
                <div className="flex flex-col w-[70%] text-start ml-5">
                  <h5 className="my-5 text-white font-semibold">
            ...
            <div className="w-[200px] h-[170px] bg-[#595959] ml-8">
              <div className="flex flex-row text-center">
                <div className="flex flex-col mt-5 ml-5">
                  <img src="/Group7.png" alt="" className="w-9 mb-4" />
                  <img src="/Group5.png" alt="" className="w-4 h-16 ml-2" />
                </div>
                <div className="flex flex-col w-[70%] text-start ml-5">
                  <h5 className="my-5 text-white font-semibold">
